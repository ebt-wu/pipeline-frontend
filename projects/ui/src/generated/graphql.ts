...
export type MutationDeleteNotManagedServiceArgs = {
  componentId: Scalars['String']['input']
  projectId: Scalars['String']['input']
...
export type WatchPipelineSubscription = {
  __typename?: 'Subscription'
  watchPipeline: {
    __typename?: 'Pipeline'
    name: string
    pipelineType: PipelineType
    namespace: string
    automaticdClientName: string
    automaticdClientNamespace: string
    labels: Array<{ __typename?: 'Label'; key: string; value: string }>
    resourceRefs?: Array<{
      __typename?: 'ResourceRef'
      kind: string
      status: string
...
export type WatchNotManagedServicesSubscription = {
  ...
  watchNotManagedServices: {
    __typename?: 'NotManagedServices'
    pipelineCreationTimestamp: string
    azureDevOps?: {
      __typename?: 'AzureDevOps'
      azurePipelineName: string
      azureProjectName: string
      azurePipelineId: number
      pipelineDefinitionUrl: string
      secretPath?: string | null
    } | null
    cnb?: { __typename?: 'CNB'; builder: string; path: string } | null
    xmake?: {
      __typename?: 'XMake'
      id: string
      uuid: string
      projectPortalProjectUrl: string
      secretPath?: string | null
    } | null
    commonRepository?: { __typename?: 'CommonRepository'; secretPath?: string | null } | null
    blackDuckHub?: {
      __typename?: 'BlackDuckHub'
      pipelineName: string
      ppmsId: string
    ...
    fortify?: { __typename?: 'Fortify'; projectName: string; secretPath?: string | null } | null
    whiteSource?: {
      __typename?: 'WhiteSource'
      productName: string
      productUrl: string
    ...
    ppmsFoss?: { __typename?: 'PpmsFoss'; scvId: string; scvName: string; ppmsLightSCVURL: string } | null
    kubernetes?: {
      __typename?: 'Kubernetes'
      chartPath: string
      acceptance: {
...
export type GetCumulusPipelineQuery = {
  __typename?: 'Query'
  getCumulusPipeline?: {
    __typename?: 'CumulusPipeline'
    id?: string | null
...
export type RemoveStagingServiceCredentialMutation = {
  __typename?: 'Mutation'
  removeStagingServiceCredential?: string | null
}
...
export type GetStagingServiceCredentialQuery = {
  __typename?: 'Query'
...
export type GetJenkinsPipelineQuery = {
  __typename?: 'Query'
  getJenkinsPipeline?: {
    __typename?: 'JenkinsPipeline'
    name?: string | null
...
export type GetPiperConfigQuery = {
  __typename?: 'Query'
  getPiperConfig: {
    __typename?: 'PiperConfig'
...
export type EnsureVaultOnboardingMutation = {
  __typename?: 'Mutation'
  ensureVaultOnboarding: { __typename?: 'VaultOnboardingInfo'; token: string; vaultUrl: string }
}
...
export type GetGithubActionsSolinasVerificationQuery = {
  __typename?: 'Query'
...
export type CreateGitHubAdvancedSecurityMutation = {
  __typename?: 'Mutation'
  createGitHubAdvancedSecurity?: string | null
}
...
export type GetGitHubAdvancedSecurityQuery = {
  __typename?: 'Query'
  getGitHubAdvancedSecurity?: {
    __typename?: 'GitHubAdvancedSecurityGetPayload'
    githubInstance: string
...
export type DeleteGitHubAdvancedSecurityMutation = {
  __typename?: 'Mutation'
...
export type GetOscRegistrationQuery = {
  ...
  getOscRegistration?: {
    __typename?: 'OpenSourceComplianceGetResponse'
    oscResourceName: string
    cumulusPipelineId: string
    isActive?: boolean | null
    ghRepoRef?: string | null
    ppmsScv?: string | null
    jiraRef?: string | null
    creationTimestamp?: string | null
  } | null
...
export type GetJiraProjectsQuery = {
  __typename?: 'Query'
  getJiraProjects?: Array<{
    __typename?: 'JiraProject'
